    ...
    public function run()
{
    $services = [
        [
            ...
            'price' => 0.00,
            'icon' => '1681896511_Web Development.png',
            'service_id' => 'S001',
        ],
        [
            ...
            'price' => 0.00,
            'icon' => '1681896891_App Development.webp',
            'service_id' => 'S002',
        ],
        [
            'name' => 'Tech Support',
            ...
            'price' => 0.00,
            'icon' => '1681897039_Tech Support.jpg',
            'service_id' => 'S003',
        ],
        [
            ...
            'price' => 0.00,
            'icon' => '1681897855_4IR Skills Training.jpg',
            'service_id' => 'S004',
        ],
        [
            ...
            'price' => 0.00,
            'icon' => '1681898499_IT Integration Solution.jpg',
            'service_id' => 'S005',
        ],
        [
            'name' => 'IT Outsourcing',
            ...
            'price' => 0.00,
            'icon' => '1681898990_IT Outsourcing.jpg',
            'service_id' => 'S006',
        ],
    ];
