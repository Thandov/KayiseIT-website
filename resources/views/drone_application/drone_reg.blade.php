            ...
            <form method="POST" action="{{ route('drone_application') }}">
                ...
                <div class="registration-section current-section" id="section1">
                    ...
                    <div class="mb-4" style="display: inline;">
                        ...
                        <input type="text" id="surname" name="surname" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4">
                        <label for="dob" class="block text-sm font-medium text-gray-600">Date Of Birth</label>
                        <input id="dob" name="dob" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4">
                        <x-input-label for="gender" :value="__('Gender')" />
                        <select name="gender" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="age" name="age" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <x-input-label for="level" :value="__('Highest Education Level')" />
                        <select name="highest_level" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" required>
                    ...
                    <div class="mb-4" style="display: inline;">
                        ...
                        <input type="text" id="school_name" name="school_name" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="number" class="block text-sm font-medium text-gray-600">Phone Number</label>
                        <input id="number" name="number" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="address" class="block text-sm font-medium text-gray-600">Home Adress</label>
                        <input id="address" name="address" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mt-6">
                ...
                <div class="registration-section" id="section2">
                    ...
                    <div class="mb-4" style="display: inline;">
                        ...
                        <input type="text" id="guardian_name" name="guardian_name" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="relation" class="block text-sm font-medium text-gray-600">Relation</label>
                        <input type="text" id="relation" name="relation" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="guardian_number" class="block text-sm font-medium text-gray-600">Phone Number</label>
                        <input id="guardian_number" type="number" name="guardian_number" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="guardian_email" class="block text-sm font-medium text-gray-600">Email</label>
                        <input id="guardian_email" name="guardian_email" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="guardian_address" class="block text-sm font-medium text-gray-600">Home Adress</label>
                        <input id="guardian_address" name="guardian_address" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mt-6">
                ...
                <div class="registration-section" id="section3">
                    ...
                    <div class="mb-4" style="display: inline;">
                        ...
                        <input type="text" id="kin_name_2" name="kin_name" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="relation_2" class="block text-sm font-medium text-gray-600">Relation</label>
                        <input type="text" id="relation_2" name="kin_relation" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mb-4" style="display: inline;">
                        <label for="kin_number_2" class="block text-sm font-medium text-gray-600">Phone Number</label>
                        <input id="kin_number_2" type="number" name="kin_number" class="mt-1 p-2 w-full border rounded-md" required>
                    </div>
                    <div class="mt-6">
                ...
                <div class="registration-section" id="section4">
                    ...
                    <div class="mb-4" style="display: inline;">
                        ...
                        <select name="course" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" required>
