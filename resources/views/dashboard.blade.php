<x-app-layout title="Home">
    ...
    <div class="jumbotron bg-gray-400 bg-gradient position-relative">
        <img src="{{ asset('images/kayise-logo.png') }}" alt="KAYISE IT" class="landinglogo animate__animated animate__fadeInUp">
        <div class="owl-carousel owl-theme" id="headercara">
            ...
            <x-carousel-item pic="{{ asset('images/landing-page/banner3.png') }}" topTitle="We specialize" mainTitle="Event Cleaning" bottomTitle="asd" />
        </div>
    </div>
