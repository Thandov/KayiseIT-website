...
<x-app-layout title="Home">
    ...
    <div class="jumbotron bg-gray-400 bg-gradient position-relative">
        ...
        <div class="owl-carousel owl-theme" id="headercara">
            <x-carousel-item pic="../images/carousel/banner1.png" topTitle="Aaaa" mainTitle="asasA"
                bottomTitle="dddd" />
            <x-carousel-item pic="../images/carousel/banner2.png" topTitle="We specialize"
                mainTitle="Commercial Cleaning" bottomTitle="dddd" />
            <x-carousel-item pic="../images/carousel/banner3.png" topTitle="We specialize"
                mainTitle="Event Cleaning" bottomTitle="asd" />
        </div>
    </div>
