...
<div class="container py-5 px-4 md:px-8 max-w-screen-xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-3 justify-center gap-4">
        ...
        <a href="mailto:info@kayiseit.co.za" class=" border-none rounded-md w-64 bg-slate-100">
        ...
        <a href="tel:+27877022625" class=" border-none rounded-md w-64 bg-slate-100">
            <div class="flex justify-center p-2">
        ...
        <a href="https://maps.app.goo.gl/PANTYMHfVkWBoKSp7" class="border-none rounded-md w-64 bg-slate-100">
            <div class="flex justify-center p-2">
