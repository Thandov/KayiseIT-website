        ...
        <div class="container max-w-7xl">
            <div class="row">
                <div class="col-md-6  px-10">
                    ...
                    <br>
                    <div>
                        <p class="smalltxt font-bold fs-5">Send us an email or give us a call and get top shelf advice on the best IT strategies to help grow your business online.</p>
                    </div>
                    <br>
                    <div>
