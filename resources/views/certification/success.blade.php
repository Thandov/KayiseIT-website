<x-app-layout title="Congratulations!">
    ...
    <div class="min-h-[80vh] flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-b from-emerald-50 to-white">
        <div class="text-center max-w-2xl">
            <h1 class="text-6xl sm:text-7xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 mb-6 animate-pop-in">
                Congratulations
            </h1>
            ...
            <a href="{{ route('certification.download', ['token' => $token]) }}" style="display: inline-flex; align-items: center; padding: 1rem 2rem; background: #059669; color: white !important; font-weight: 700; font-size: 1.125rem; border-radius: 0.75rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05); text-decoration: none; transition: background 0.2s;" onmouseover="this.style.background='#047857'" onmouseout="this.style.background='#059669'">
