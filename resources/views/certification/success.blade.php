<x-app-layout title="Congratulations!">
    ...
    <div class="min-h-[80vh] flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-b from-emerald-50 to-white">
        <div class="text-center max-w-4xl w-full pt-16">
            ...
            <a href="{{ route('certification.download', ['name' => $download_name, 'surname' => $download_surname]) }}" style="display: inline-flex; align-items: center; padding: 1rem 2rem; background: #059669; color: white !important; font-weight: 700; font-size: 1.125rem; border-radius: 0.75rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05); text-decoration: none; transition: background 0.2s;" onmouseover="this.style.background='#047857'" onmouseout="this.style.background='#059669'">
