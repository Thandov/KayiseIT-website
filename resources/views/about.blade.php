  ...
  <div class="container">
    <div class="row flex flex-wrap justify-center">
      <div class="col-7 sm-col-12">
        ...
        <br>
        <a href="services" class="hire">Discover More</a>
      </div>
      <div class="col-4 position-relative px-20">
        <img src="../images/contact.jpg" width="400" height="400" class="rounded" style="position: absolute; top: -150px; left: -5; right: 0; z-index: 1;" data-aos="fade-left" data-aos-delay="300">
      </div>
    </div>
  </div>
</div>
