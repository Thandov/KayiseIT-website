<div class="grid grid-cols-3 p-4 md:p-12">
    ...
    <!--  <div class="p-4 md:p-12">
        ...
        <div class="data my-4 md:my-8 md:mr-auto text-center">
     ...
     <div class="grid grid-cols-2 gap-4 col-span-2">
        <div class="card-iot">
            <img src="/images/carousel/cara4.png" alt="Image 1" class="w-full h-full object-cover">
        </div>
        <div class="card-iot">
            <img src="/images/icons/blockchain.jpeg" alt="Image 2" class="w-full h-full object-cover">
        </div>
        <div class="card-iot">
