    ...
    <form action="{{ route('contactsubmit') }}" method="post" id="contactForm" enctype="multipart/form-data">
        ...
        <fieldset>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="w-full">
                    <label for="name" class="block text-green-500 font-medium mb-2">Your Name</label>
                ...
                <div class="w-full">
                    <label for="email" class="block text-green-500 font-medium mb-2">Your Email</label>
                    <div class="relative rounded-md shadow-sm">
        ...
        <div class="mt-8">
            <label for="subject" class="block text-green-500 font-medium mb-2">Subject</label>
            <div class="relative rounded-md shadow-sm">
        ...
        <div class="mt-8">
            <label for="message" class="block text-green-500 font-medium mb-2">Message</label>
            <div class="relative rounded-md shadow-sm">
