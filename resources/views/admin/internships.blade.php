    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $internship->id }}</td>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $internship->name }}</td>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $internship->created_at }}</td>
                    <td class="py-3 px-6 text-center row">
                        <div class="py-3 px-6 col-6">
                            <a href="{{ url('dashboard/viewinternship/'.$internship->id) }}" title="View">
