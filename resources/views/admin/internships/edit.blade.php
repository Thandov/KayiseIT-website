    ...
    <div class="max-w-6xl mx-auto py-8">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
                <h2 class="text-2xl font-bold">Edit Internship Application</h2>
                <p class="text-blue-200">Update the internship application details.</p>
            </div>
            
            <form method="POST" action="{{ route('dashboard.internships.update', $internship->id) }}" class="p-6" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" 
                                   id="id_no" 
                                   name="id_no" 
                                   value="{{ old('id_no', $internship->id_no) }}" 
                               required
                    ...
                    <div>
                            ...
                            <input type="text" 
                                   id="address" 
                                   name="address" 
                                   value="{{ old('address', $internship->address) }}" 
                               required
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="high_school" 
                                   name="high_school" 
                                   value="{{ old('high_school', $internship->high_school) }}" 
                                   required
                    ...
                    <div>
                        ...
                        <input type="text" 
                                   ...
                                   value="{{ old('year_of_completion', $internship->year_of_completion) }}" 
                               required
                                   pattern="[0-9]{4}"
                    ...
                    <div>
                            ...
                            <input type="text" 
                                   id="year_obtained" 
                                   name="year_obtained" 
                                   value="{{ old('year_obtained', $internship->year_obtained) }}" 
                                required
                                   pattern="[0-9]{4}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="app_type" 
                                ...
                                <option value="Full Time" {{ old('app_type', $internship->app_type) == 'Full Time' ? 'selected' : '' }}>Full Time</option>
                                <option value="Part Time" {{ old('app_type', $internship->app_type) == 'Part Time' ? 'selected' : '' }}>Part Time</option>
                                <option value="Remote" {{ old('app_type', $internship->app_type) == 'Remote' ? 'selected' : '' }}>Remote</option>
                            </select>
                            @error('app_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="field" 
                                ...
                                <option value="Software Development" {{ old('field', $internship->field) == 'Software Development' ? 'selected' : '' }}>Software Development</option>
                                <option value="Web Development" {{ old('field', $internship->field) == 'Web Development' ? 'selected' : '' }}>Web Development</option>
                                <option value="Data Analysis" {{ old('field', $internship->field) == 'Data Analysis' ? 'selected' : '' }}>Data Analysis</option>
                                <option value="IT Support" {{ old('field', $internship->field) == 'IT Support' ? 'selected' : '' }}>IT Support</option>
                                <option value="Digital Marketing" {{ old('field', $internship->field) == 'Digital Marketing' ? 'selected' : '' }}>Digital Marketing</option>
                                <option value="Others" {{ old('field', $internship->field) == 'Others' ? 'selected' : '' }}>Others</option>
                            </select>
                            @error('field')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="mb-8">
                    ...
                    @if($internship->cv_path || $internship->id_copy_path || $internship->qualification_copy_path)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <!-- CV Upload -->
                        <div>
                            <label for="cv_file" class="block text-sm font-medium text-gray-700 mb-2">CV/Resume (Optional)</label>
                            <input type="file" 
                                   id="cv_file" 
                                   name="cv_file" 
                                   accept=".pdf,.doc,.docx"
                        ...
                        <!-- ID Copy Upload -->
                        <div>
                            <label for="id_copy_file" class="block text-sm font-medium text-gray-700 mb-2">ID Copy (Optional)</label>
                            <input type="file" 
                                   id="id_copy_file" 
                                   name="id_copy_file" 
                        ...
                        <div>
                            <label for="qualification_copy_file" class="block text-sm font-medium text-gray-700 mb-2">Qualification Copy (Optional)</label>
                            <input type="file" 
                    ...
                    <p class="text-sm text-gray-500 mt-2">Leave empty to keep current files, or upload new files to replace them.</p>
                </div>
