    ...
    <div class="p-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3 min-w-0">
                <a href="{{ route('dashboard.services') }}" class="flex items-center gap-2 text-gray-500 hover:text-gray-700 transition shrink-0">
            ...
            <div class="flex flex-wrap gap-2 text-xs">
                <span class="text-gray-500 self-center mr-1">Public tier pages:</span>
                <a href="{{ route('service.show.tier', ['slug' => $pub, 'tier' => 'small']) }}" target="_blank" rel="noopener" class="text-kb-600 hover:underline">Small</a>
                <a href="{{ route('service.show.tier', ['slug' => $pub, 'tier' => 'medium']) }}" target="_blank" rel="noopener" class="text-kb-600 hover:underline">Medium</a>
                <a href="{{ route('service.show.tier', ['slug' => $pub, 'tier' => 'enterprise']) }}" target="_blank" rel="noopener" class="text-kb-600 hover:underline">Enterprise</a>
            </div>
