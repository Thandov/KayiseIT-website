<div class="p-6">
    ...
    <div class="mb-6 bg-kb-50 rounded-xl p-6 border border-kb-200 shadow-lg">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <div class="bg-kb-100 rounded-lg p-3">
            ...
            <div class="flex items-center space-x-4">
                ...
                @endif
                <select id="featured-gallery-select" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-kb-100 focus:border-kb-100 text-sm">
    ...
    <div class="flex items-center justify-between mb-6 bg-gray-50 rounded-xl p-4 border border-gray-100">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600">Manage your image collection</p>
            </div>
        </div>
        <div class="flex space-x-3">
            <button onclick="openUploadModal(false)" class="inline-flex items-center px-6 py-3 bg-kb-100 border border-transparent rounded-xl font-medium text-sm text-white hover:bg-kb-200 focus:outline-none focus:ring-2 focus:ring-kb-100 focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                </svg>
                Upload Images
            </button>
            <button onclick="openUploadModal(true)" class="inline-flex items-center px-6 py-3 bg-kg-700 border border-transparent rounded-xl font-medium text-sm text-white hover:bg-kg-600 focus:outline-none focus:ring-2 focus:ring-kg-700 focus:ring-offset-2 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
        ...
        <!-- Gallery Content -->
        <div id="gallery-content" class="p-6">
