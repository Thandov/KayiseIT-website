...
@section('content')
    <div class="p-6">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Create New Partner</h2>
                <p class="text-sm text-gray-600">Add a new partner to your website</p>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="partner_type" 
                                ...
                                <option value="Skills Development" {{ old('partner_type') == 'Skills Development' ? 'selected' : '' }}>Skills Development</option>
                                <option value="JV" {{ old('partner_type') == 'JV' ? 'selected' : '' }}>JV</option>
                                <option value="Sponsor" {{ old('partner_type') == 'Sponsor' ? 'selected' : '' }}>Sponsor</option>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-kb-400 transition-colors">
                                <div class="space-y-3 text-center w-full">
                                    <div id="logo-placeholder" class="space-y-1">
                                    ...
                                    <img id="logo-preview" class="mx-auto h-24 w-auto object-contain rounded-md border border-gray-200 bg-gray-50 hidden" alt="Partner logo preview">
                                </div>
                            </div>
                            @error('logo')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      id="description" 
                                      rows="4"
                                      class="mt-1 focus:ring-kb-500 focus:border-kb-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
