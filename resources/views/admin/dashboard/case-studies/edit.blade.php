...
@section('content')
    <div class="max-w-4xl mx-auto py-8 px-4">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
                ...
                <p class="mt-1 text-sm text-gray-600">Update the case study information.</p>
            </div>
            ...
            <form action="{{ route('dashboard.case-studies.update', $caseStudy->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    @if($caseStudy->image)
                        <div class="mb-3">
                            <img src="{{ $caseStudy->image }}" alt="Current image" class="w-full max-w-md h-48 object-cover rounded-lg border border-gray-200">
                ...
                <div class="mb-6">
                    ...
                    <input type="url" 
                           name="hyperlink" 
                           id="hyperlink" 
                           value="{{ old('hyperlink', $caseStudy->hyperlink) }}"
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="has_gallery"
                               value="1"
                               {{ old('has_gallery', $caseStudy->has_gallery) ? 'checked' : '' }}
                ...
                <div id="gallerySection" class="mb-6 {{ old('has_gallery', $caseStudy->has_gallery) ? '' : 'hidden' }}">
                    <!-- Existing Gallery Images -->
                    @if($caseStudy->galleryImages && $caseStudy->galleryImages->count() > 0)
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                @foreach($caseStudy->galleryImages as $galleryImage)
                                    <div class="relative">
                                        <img src="{{ $galleryImage->image_path }}" alt="Gallery image" class="w-full h-32 object-cover rounded-lg border border-gray-200">
                    ...
                    <label for="gallery_images" class="block text-sm font-medium text-gray-700 mb-2">
                        Add More Gallery Images (Multiple images allowed)
                    </label>
                    <input type="file" 
                           name="gallery_images[]" 
                           id="gallery_images" 
                ...
                <div class="mb-6">
                    ...
                    <div id="results-list-container">
                        @if($caseStudy->results_list && count($caseStudy->results_list) > 0)
                            @foreach($caseStudy->results_list as $index => $result)
                ...
                <div class="mb-6">
                    ...
                    <input type="number" 
                           name="order" 
                           id="order" 
                           value="{{ old('order', $caseStudy->order) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
    ...
    <script>
        let resultItemCount = {{ $caseStudy->results_list ? count($caseStudy->results_list) : 1 }};
        ...
        function toggleGallerySection() {
            const checkbox = document.getElementById('has_gallery');
