                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500">New Employee</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="px-4 py-3 sm:px-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">New Staff</h3>
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">Enter details of the new staff.</p>
                </div>
                <form action="{{ url('admin/staff/create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6 px-4 sm:px-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="ID_number" maxlength="13" id="ID_number" autocomplete="ID_number" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('ID_number') border-red-500 @enderror" value="{{ old('ID_number') }}">
                            @error('ID_number')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="file" name="profile_picture" id="profile_picture" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('profile_picture') border-red-500 @enderror">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="date" name="date_of_birth" id="date_of_birth" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('date_of_birth') border-red-500 @enderror" value="{{ old('date_of_birth') }}">
                            @error('date_of_birth')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
