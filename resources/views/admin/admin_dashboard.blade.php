        ...
        <div class="w-45 h-full px-4 py-8 bg-white border-r overflow-x-hidden overflow-y-scroll">
            ...
            <div class="mt-6">
                ...
                <nav class="grid grid-flow-row">
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'dashboard'" @click.prevent="activeTab = 'dashboard'" href="#">Dashboard</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'clients'" @click.prevent="activeTab = 'clients'" href="#">Clients</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'staff'" @click.prevent="activeTab = 'staff'" href="#">Staff</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'gallery'" @click.prevent="activeTab = 'gallery'" href="#">Gallery</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'carousel'" @click.prevent="activeTab = 'carousel'" href="#">Carousel</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'services'" @click.prevent="activeTab = 'services'" href="#">Services</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'applications'" @click.prevent="activeTab = 'applications'" href="#">Applications</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'internships'" @click.prevent="activeTab = 'internships'" href="#">Internships</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'invoices'" @click.prevent="activeTab = 'invoices'" href="#">Invoices</a>
                    <a class="bg-blue-100 py-2 px-3 mb-2" :active="activeTab === 'quotations'" @click.prevent="activeTab = 'quotations'" href="#">Quotations</a>
                </nav>
            </div>
        </div>
