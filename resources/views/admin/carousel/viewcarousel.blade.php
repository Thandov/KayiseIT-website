                ...
                <div class="overflow-hidden shadow-sm sm:rounded-lg p-6 bg-white border-b border-gray-200 md:col-span-3">
                    <div class="grid grid-row-3 gap-4 px-4 sm:px-6">
                        <div class="col">
                            ...
                            <input type="text" name="head_title" id="head_title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('middletxt') border-red-500 @enderror" value="{{ $carousel->title }}">
                            @error('head_title')
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="middletxt" id="middletxt" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('middletxt') border-red-500 @enderror" value="{{ $carousel->middletxt }}">
                            @error('middletxt')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="col">
                            ...
                            <input type="text" name="btmtxt" id="btmtxt" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('btmtxt') border-red-500 @enderror" value="{{ $carousel->btmtxt }}">
                            @error('btmtxt')
                            <p class="text-red-500 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
