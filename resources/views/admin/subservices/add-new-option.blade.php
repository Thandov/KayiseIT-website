<form action="{{ route('addoptions.add', $subservice->id) }}" method="post" enctype="multipart/form-data" class="px-3 py-3">
    ...
    <div class="m-3 row">
        ...
        <div class="col-sm-9">
            <select  name="quantified" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full">
