...
class AddKayiseServices extends Command
{
    protected $signature = 'kayise:add-services';
    protected $description = 'Add KAYISE IT services to the database';
    ...
    public function handle()
    {
        ...
        foreach ($services as $serviceData) {
            ...
            if (!$existingService) {
                ...
                $this->info("✓ Added: {$serviceData['name']}");
                $added++;
            } else {
                $this->line("⊘ Skipped: {$serviceData['name']} (already exists)");
                $skipped++;
            }
        }
